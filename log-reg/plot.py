...
def visualize_conf(current_model, title, X_test_scaled, y_test):
    """
    Visualize the confusion matrix for a given model's predictions.

    Args:
        current_model: The trained model.
